import { colours, isValidColour } from "../src/index";
...
describe('calculateCost', () => {
    it('returns the total cost for a brand with multiple colours', () => {
        ...
        colours[0][1] = 10; // set PEACH to 10 liters
        colours[1][1] = 5; // set CREAM to 5 liters
        colours[2][1] = 2.5; // set CLAY to 2.5 liters

        colours[3][1] = 0; // // set WHITE to 0 liters
        colours[4][1] = 0; // set INDIGO to 11 liters
        colours[6][1] = 0; // set SAGE to 7.5 liters
    ...
    it('returns the total cost for a brand with multiple colours', () => {
        ...
        colours[0][1] = 10; // set PEACH to 10 liters
        colours[1][1] = 0; // set CREAM to 0 liters
        colours[2][1] = 0; // set CLAY to 0 liters
        colours[3][1] = 0; // // set WHITE to 0 liters
        colours[4][1] = 11; // set INDIGO to 11 liters
        colours[6][1] = 7.5; // set SAGE to 7.5 liters
